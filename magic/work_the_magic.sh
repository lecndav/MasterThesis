...
python3 ../data_transformation/01_to_hdf5.py -m "${data}/Testdata_mf4_snippet" -o "${dir_name}/stage1" -d $time
...
python ../magic/magic.py -i "${dir_name}/stage4" -c ../config/random_forest.yml
